        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredProjects.map((project, idx) => {
              // Transform the project data to match ProjectCard interface
              const transformedProject = {
                id: project.id,
                title: project.title,
                description: `A high-quality, ready-to-use ${project.category} project for students.`,
                ...
                stats: {
                  stars: project.seller.rating * 20, // Convert rating to star count
                  likes: project.sales * 2, // Estimate likes from sales
                  views: project.sales * 15, // Estimate views from sales
                  sales: project.sales,
                },
                price: parseInt(project.price.replace(/[₹$]/g, '')),
                originalPrice: parseInt(project.originalPrice.replace(/[₹$]/g, '')),
                rating: project.rating,
                reviews: project.reviews,
                featured: idx === 0, // Mark first as featured
                trending: idx < 2, // Mark first two as trending
              ...
              return (
                <div key={project.id} className="animate-slideInUp" style={{ animationDelay: `${idx * 100}ms` }}>
                  <ProjectCard
